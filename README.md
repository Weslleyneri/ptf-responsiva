# Weslley Neri - AI Command Center
...
HTML, CSS e JavaScript, sem dependencia de servidor ou banco de dados.

## Publicacao

O GitHub Actions publica automaticamente a branch `main` no GitHub Pages a cada atualizacao.
